...
const FinanceiroRecorrente = ({titulo, setInfo}) => {
    ...
    const cadastrar = () => {
        navigate(`/financeiro/cadastro-recorrente`);
    };

    const editar = (id) => {
        navigate(`/financeiro/cadastro-recorrente/${id}`);
    };
    ...
    return(
        <div className="conteudo-principal">
            ...
            <div className='conteudo-principal-central'>
                ...
                <tbody>
                    <tr>
                        {colunaDespesa.map(({id, nome, classe}) => (
...
export default FinanceiroRecorrente